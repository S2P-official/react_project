            ...
            <div>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3">
                <input
                  ...
                  className="px-4 py-2 border rounded-md w-full sm:w-64 focus:ring-2 focus:ring-blue-500"
                  value={pincode}
                  onChange={(e) => setPincode(e.target.value)}
                />
                <button className="bg-black text-white px-4 py-2 rounded-md hover:bg-gray-800">Check</button>
              </div>

              <div className="mt-6 flex flex-col sm:flex-row gap-4">
                <button
                  onClick={handleAddToCart}
                  className="bg-orange-500 text-white w-full sm:w-auto px-6 py-2 rounded-md hover:bg-orange-600"
                >
                  ADD TO CART
                </button>
                <button
                  onClick={() => alert('Redirecting to payment (not implemented)')}
                  className="bg-red-600 text-white w-full sm:w-auto px-6 py-2 rounded-md hover:bg-red-700"
                >
                  BUY NOW
                </button>
              </div>
