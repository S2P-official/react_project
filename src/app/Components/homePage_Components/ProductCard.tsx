...
const ProductCard: React.FC<ProductCardProps> = ({ product }) => {
 ...
 const handleShopNow = () => {
  ...
  return (
    <div onClick={handleShopNow} className="bg-white p-4 rounded-xl shadow-md hover:shadow-lg transition  hover:shadow-xl hover:scale-105 transform transition duration-300 ease-in-out">
      {/* Product Image */}
